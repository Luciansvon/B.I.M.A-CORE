...
Full rules live in [`CLAUDE.md`](CLAUDE.md), the canonical source. Memorize all 8 rules. The non-negotiable ones:
...
- **Strict EXPLORE→PLAN→CODE→VERIFY discipline.** Bima wrote these rules in the canonical `CLAUDE.md`.
