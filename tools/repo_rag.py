...
def _get_embedder():
    ...
    if _embedder is None:
        ...
        # Switch local/cloud via env EMBEDDING_BACKEND. Code repo butuh embedding
        # tuned untuk source code → kalau backend=cloud, pakai codestral-embed.
        _embedder = get_embedder("code")
    return _embedder
