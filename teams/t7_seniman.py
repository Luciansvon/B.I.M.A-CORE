...
seniman_agent = Agent(
    ...
    goal="""Membuat visualisasi data, diagram, aset UI, dan optimize prompt HANYA jika diminta secara eksplisit.
    ...
    - Input JSON: {"prompt": "<prompt mentah>", "target_model": "claude|gpt|gemini", "task_type": "code|writing|analysis|general"}
    - Default target_model="gpt", task_type="general" kalau Bima gak sebut.
    - Output: score 6-axis + critique + rewrite + reasoning, sudah formatted markdown.
    - Forward output ke Bima apa adanya, jangan diringkas.
