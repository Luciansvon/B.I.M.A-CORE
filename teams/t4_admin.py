...
# ImageSearchTool extracted ke tools/image_search_tool.py supaya bisa di-share
# ke team Intel (user-facing image search). Tetap di-import + dipakai sini buat
# embed gambar di PDF/Word (existing flow).
